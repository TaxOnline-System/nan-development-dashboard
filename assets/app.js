...
function mapRows(rows, source){
  return rows.map((r,index)=>{
    ...
    return {
      ...
      alignedPlan:get('alignedPlan')||'ไม่พบข้อมูล', alignedIndicatorTarget:get('alignedIndicatorTarget')||'ไม่พบข้อมูล',
      alignedProvincialGoal:get('alignedProvincialGoal')||'ไม่พบข้อมูล',
