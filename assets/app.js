...
function mapRows(rows, source){
  return rows.map((r,index)=>{
    ...
    return {
      ...
      sdgText, sdgs:extractSdgs(sdgText), sdgKeyword:get('sdgKeyword')||'ไม่พบข้อมูล (อยู่ระหว่างการวิเคราะห์ข้อมูล)', alignment:get('alignment')||'ไม่ระบุ (อยู่ระหว่างการวิเคราะห์ข้อมูล)',
